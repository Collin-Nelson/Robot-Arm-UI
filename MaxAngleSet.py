...
class MaxAngleSet(wx.Panel):
    def __init__(self, parent, serial):
        wx.Panel.__init__(self, parent=parent, size=(200, 500), style=wx.SUNKEN_BORDER)

        self.serial = serial

        serial.pass_max_angle_set_panel(self)

        title = wx.StaticText(self, label="Set Max Angle", size=(200, 18), style=wx.ALIGN_CENTER_HORIZONTAL)
        ...
        lbl1 = wx.StaticText(self, label="J1 Max", pos=(30, 30))
        lbl2 = wx.StaticText(self, label="J2 Max", pos=(30, 90 + 10))
        lbl3 = wx.StaticText(self, label="J3 Max", pos=(30, 150 + 20))
        lbl4 = wx.StaticText(self, label="J4 Max", pos=(30, 210 + 30))
        lbl5 = wx.StaticText(self, label="J5 Max", pos=(30, 270 + 40))
        lbl6 = wx.StaticText(self, label="J6 Max", pos=(30, 330 + 50))
    ...
    def set_max_angle(self, joint_id, angle):
        if joint_id == 1:
