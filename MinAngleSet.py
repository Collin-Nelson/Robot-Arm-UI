...
class MinAngleSet(wx.Panel):
    def __init__(self, parent, serial):
        wx.Panel.__init__(self, parent=parent, size=(200, 500), style=wx.SUNKEN_BORDER)

        self.serial = serial

        serial.pass_min_angle_set_panel(self)

        title = wx.StaticText(self, label="Set Min Angle", size=(200, 18), style=wx.ALIGN_CENTER_HORIZONTAL)
        ...
        lbl1 = wx.StaticText(self, label="J1 Min", pos=(30, 30))
        lbl2 = wx.StaticText(self, label="J2 Min", pos=(30, 90 + 10))
        lbl3 = wx.StaticText(self, label="J3 Min", pos=(30, 150 + 20))
        lbl4 = wx.StaticText(self, label="J4 Min", pos=(30, 210 + 30))
        lbl5 = wx.StaticText(self, label="J5 Min", pos=(30, 270 + 40))
        lbl6 = wx.StaticText(self, label="J6 Min", pos=(30, 330 + 50))
    ...
    def set_min_angle(self, joint_id, angle):
        if joint_id == 1:
    ...
    def btn1_press(self, event):
        ...
        if not value:
            ...
            self.serial.serial_write("m1:" + value)
    ...
    def btn2_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("m2:" + value)
    ...
    def btn3_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("m3:" + value)
    ...
    def btn4_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("m4:" + value)
    ...
    def btn5_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("m5:" + value)
    ...
    def btn6_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("m6:" + value)
    ...
    def btn7_press(self, event):
        ...
        self.serial.serial_write("m1:" + value1 + ".m2:" + value2 + ".m3:" + value3 +
