...
class AccelSet(wx.Panel):
    def __init__(self, parent, serial):
        wx.Panel.__init__(self, parent=parent, size=(200, 500), style=wx.SUNKEN_BORDER)

        self.serial = serial

        serial.pass_accel_set_panel(self)

        title = wx.StaticText(self, label="Set Acceleration", size=(200, 18), style=wx.ALIGN_CENTER_HORIZONTAL)
        ...
        lbl1 = wx.StaticText(self, label="J1 Accel", pos=(30, 30))
        lbl2 = wx.StaticText(self, label="J2 Accel", pos=(30, 90 + 10))
        lbl3 = wx.StaticText(self, label="J3 Accel", pos=(30, 150 + 20))
        lbl4 = wx.StaticText(self, label="J4 Accel", pos=(30, 210 + 30))
        lbl5 = wx.StaticText(self, label="J5 Accel", pos=(30, 270 + 40))
        lbl6 = wx.StaticText(self, label="J6 Accel", pos=(30, 330 + 50))
    ...
    def set_accel(self, joint_id, accel):
        if joint_id == 1:
            self.tc1.SetValue(accel)
        if joint_id == 2:
            self.tc2.SetValue(accel)
        if joint_id == 3:
            self.tc3.SetValue(accel)
        if joint_id == 4:
            self.tc4.SetValue(accel)
        if joint_id == 5:
            self.tc5.SetValue(accel)
        if joint_id == 6:
            self.tc6.SetValue(accel)
    ...
    def btn1_press(self, event):
        ...
        if not value:
            ...
            self.serial.serial_write("A1:" + value)
    ...
    def btn2_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("A2:" + value)
    ...
    def btn3_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("A3:" + value)
    ...
    def btn4_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("A4:" + value)
    ...
    def btn5_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("A5:" + value)
    ...
    def btn6_press(self, event):
        ...
        if not value:
            ...
            print(f'You typed: "{value}"')
            self.serial.serial_write("A6:" + value)
    ...
    def btn7_press(self, event):
        ...
        self.serial.serial_write("A1:" + value1 + ".A2:" + value2 + ".A3:" + value3 +
                                 ".A4:" + value4 + ".A5:" + value5 + ".A6:" + value6)
